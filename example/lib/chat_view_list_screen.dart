...
class _ChatViewListScreenState extends State<ChatViewListScreen> {
  late final ChatViewListController chatViewListController;
  ...
  void initState() {
    ...
    chatViewListController = ChatViewListController(
      chatViewListUsers: chatViewListUsers,
    ...
    return Scaffold(
      body: ChatViewList(
        ...
        config: ChatViewListConfig(
          profileWidgetConfig: const ProfileWidgetConfig(
          ...
          searchConfig: SearchConfig(
            ...
            onSearch: (value) async {
              ...
              final list = chatViewListController.chatViewListUsers
                  .where((user) =>
