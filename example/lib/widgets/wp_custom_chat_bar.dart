            ...
            if (_replyMessage?.message.isNotEmpty ?? false)
              Container(
                ...
                decoration: const BoxDecoration(
                  border: Border(
                    left: BorderSide(color: AppColors.wpReplyColor, width: 4),
                  ),
                ),
                child: Row(
                  children: [
                    ...
                    SizedBox.square(
                      ...
                      child: IconButton(
                        ...
                        icon: SvgPicture.asset(AppIcons.wpCloseCircular),
                      ),
                    ),
                  ],
                ),
                    ...
                    if (!isRecordingValue) ...[
                      SizedBox.square(
                        ...
                        child: IconButton(
                          ...
                          icon: SvgPicture.asset(AppIcons.wpPlus),
                        ),
                      ),
                            ...
                            if (!isRecordingValue) ...[
                              SizedBox.square(
                                ...
                                child: EmojiPickerActionButton(
                                  ...
                                  icon: SvgPicture.asset(AppIcons.wpSticker),
                                ...
                                children: [
                                  ...
                                  SizedBox.square(
                                    ...
                                    child: IconButton(
                                      ...
                                      icon: SvgPicture.asset(AppIcons.wpSend),
                                    ),
                                  ),
                                ],
                              );
                                  ...
                                  ? [
                                      SizedBox.square(
                                        ...
                                        child: IconButton(
                                          ...
                                          icon:
                                              SvgPicture.asset(AppIcons.wpSend),
                                        ),
                                      ),
                                    ]
                                  : [
                                      ...
                                      SizedBox.square(
                                        ...
                                        child: IconButton(
                                          ...
                                          padding: EdgeInsets.zero,
                                          icon:
                                              SvgPicture.asset(AppIcons.wpMic),
                                        ),
                                      ),
                                    ],
                            );
