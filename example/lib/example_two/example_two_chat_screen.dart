...
class _ExampleTwoChatScreenState extends State<ExampleTwoChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.wpBackground,
      body: ChatView(
            ...
            IconButton(
              ...
              onPressed: () {
                _chatController.setTypingIndicator =
                    !_chatController.typingIndicatorNotifier.value;
              },
        ...
        typeIndicatorConfig: TypeIndicatorConfiguration(
          customIndicator: Container(
            ...
            decoration: const BoxDecoration(
              color: Colors.white,
              border: AppBorders.wpMessageBorder,
            ...
            child: const Row(
              ...
              children: [
                CircleAvatar(radius: 2.75, backgroundColor: AppColors.wpGrey),
                SizedBox(width: 3),
                CircleAvatar(radius: 2.75, backgroundColor: AppColors.wpGrey),
                SizedBox(width: 3),
                CircleAvatar(radius: 2.75, backgroundColor: AppColors.wpGrey),
        ...
        chatBubbleConfig: ChatBubbleConfiguration(
          outgoingChatBubbleConfig: const ChatBubble(
            ...
            borderRadius: BorderRadius.only(
              ...
              bottomRight: Radius.circular(4), // Small tail
            ),
          ...
          inComingChatBubbleConfig: ChatBubble(
            ...
            borderRadius: const BorderRadius.only(
              topLeft: Radius.circular(12),
              topRight: Radius.circular(12),
              bottomLeft: Radius.circular(4), // Small tail
        ...
        repliedMessageConfig: RepliedMessageConfiguration(
          ...
          repliedMessageWidgetBuilder: (replyMessage) => ReplyMessageTile(
            ...
            chatController: _chatController,
            currentUserId: _chatController.currentUser.id,
          ),
        ),
